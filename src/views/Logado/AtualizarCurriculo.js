...
import { criarCurriculo, atualizarCurriculo } from "../../store/actions/curriculos/curriculo";
    ...
    return (
      <Container fluid style={{backgroundColor:"white"}}>
        <Form onSubmit={this.handleSubmit}>
          ...
          <Button
            ...
            onClick={async () => {
              if (
                ...
                await this.props.atualizarCurriculo({
          ...
          >
            <p className="App-text-button">Atualizar currículo</p>
          </Button>
        </Form>
      </Container>
    );
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    atualizarCurriculo: (curriculo) => dispatch(atualizarCurriculo(curriculo)),
  };
};
